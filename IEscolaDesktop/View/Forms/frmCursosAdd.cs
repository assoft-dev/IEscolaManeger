    ...
    public partial class frmCursosAdd : XtraUserControl
    {
        ...
        public frmCursosAdd(Cursos usuarios = null)
        {
            ...
            if (usuarios != null) {     
                ...
                txtCodigo.EditValue = usuarios.CursosID;
        ...
        private async void Apagar()
        {
            if (!string.IsNullOrWhiteSpace(txtCodigo.Text))
            {
                ...
                if (msg == DialogResult.Yes)
                {
                    ...
                    var apagar = await DataRepository.Excluir(x => x.CursosID == data);
        ...
        private async void Guardar()
        {
            ...
            if (!await ValidationDatabase())
            {
                ...
                IsValidate = ID != 0 ? await DataRepository.Guardar(data, X => X.CursosID == ID) > 0 :
        ...
        private async Task<bool> ValidationDatabase()
        {
            ...
            if (dataResult != null)
            {
                if (!string.IsNullOrWhiteSpace(txtCodigo.Text))
                {
                    if (dataResult.CursosID != Convert.ToInt32(txtCodigo.Text))
                    {
