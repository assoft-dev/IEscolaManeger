...
{
    public partial class frmMunicipios : XtraUserControl
    {
        IMunicipios DataRepository;

        List<Municipios>  DataOriginalList;
        ...
        public frmMunicipios()
        {
            ...
            DataOriginalList = new List<Municipios>();
        ...
        private void GridControl1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                var result = municipiosBindingSource.Current as Municipios;

                var forms = OpenFormsDialog.ShowForm(null,
                    new frmMunicipiosAdd(result ?? null));
        ...
        private void LeituraFilter()
        {
            var data = DataOriginalList.FindAll(x => x.Detalhes.ToUpper().Contains(txtPesquisar.Text.ToUpper()) ||
                                                         x.Detalhes.ToUpper().Contains(txtPesquisar.Text.ToUpper()));
            municipiosBindingSource.DataSource = data;
        }
