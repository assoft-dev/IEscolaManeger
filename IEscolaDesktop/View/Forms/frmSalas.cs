...
{
    public partial class frmSalas : XtraUserControl
    {
        ISalas DataRepository;

        List<Salas>  DataOriginalList;
        ...
        {
            InitializeComponent();
            DataRepository = new SalasRepository();
            DataOriginalList = new List<Salas>();
        ...
        private void GridControl1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                var result = salasBindingSource.Current as Salas;

                var forms = OpenFormsDialog.ShowForm(null,
                    new frmSalasAdd(result ?? null));
        ...
        private void LeituraFilter()
        {
            ...
            salasBindingSource.DataSource = data;
        }

        private async void LeituraInicial()
        {
            DataOriginalList = await DataRepository.GetAll();
            salasBindingSource.DataSource = DataOriginalList;
        }
