...
{
    public partial class frmProvincias : XtraUserControl
    {
        IProvincias DataRepository;

        List<Provincias>  DataOriginalList;
        ...
        public frmProvincias()
        {
            ...
            DataOriginalList = new List<Provincias>();
        ...
        private void GridControl1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                var result = provinciasBindingSource.Current as Provincias;

                var forms = OpenFormsDialog.ShowForm(null,
                    new frmProvinciasAdd(result ?? null));
        ...
        private void LeituraFilter()
        {
            ...
            provinciasBindingSource.DataSource = data;
        }

        private async void LeituraInicial()
        {
            DataOriginalList = await DataRepository.GetAll();
            provinciasBindingSource.DataSource = DataOriginalList;
        }
