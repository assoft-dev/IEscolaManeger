...
namespace IEscolaDesktop.View.Forms
{
    public partial class frmEscolaConvenioAdd : XtraUserControl
    {
        ...
        public frmEscolaConvenioAdd(DisciplinasProgramas usuarios = null)
        {
            InitializeComponent();
        ...
        {
            var dataResult = await DataRepository.Get(x => x.Descricao == txttitulo2.Text, null);
