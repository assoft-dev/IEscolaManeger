...
{
    public partial class frmMiniPauta_Trimestral : XtraUserControl
    {
        ITrimestre DataRepository;

        List<MiniPauta_Trimestre>  DataOriginalList;

        AlertControl alert = null;

        public frmMiniPauta_Trimestral()
        {
            InitializeComponent();
            DataRepository = new TrimestreRepository();
            DataOriginalList = new List<MiniPauta_Trimestre>();
        ...
        private void BtnNovo_Click(object sender, EventArgs e)
        {
            var forms = OpenFormsDialog.ShowForm(null,
                   new frmMiniPauta_TrimestreAdd(null));
        ...
        private void GridControl1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                var result = pautasTrimestresBindingSource.Current as MiniPauta_Trimestre;

                var forms = OpenFormsDialog.ShowForm(null,
                    new frmMiniPauta_TrimestreAdd(result ?? null));
